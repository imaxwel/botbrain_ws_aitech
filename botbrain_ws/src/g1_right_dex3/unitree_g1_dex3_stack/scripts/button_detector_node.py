...
class ButtonDetectorNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('frozen_model_dir', '/botbrain_ws/src/g1_right_dex3/yolonas_ocr/frozen_model')
        ...
        self.declare_parameter('debug_image_dir',  '/botbrain_ws/detect_img/button_detector')
